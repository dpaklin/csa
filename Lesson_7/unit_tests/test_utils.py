...
from Lesson_4.common.utils import get_data, send_data
...
class TestUtils(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        send_data(test_socket, self.test_dict_send)
        ...
        self.assertRaises(TypeError, send_data, test_socket, "wrong_dictionary")
    ...
    def test_get_message(self):
        ...
        self.assertEqual(get_data(test_sock_ok), self.test_dict_recv_ok)
        # тест корректной расшифровки ошибочного словаря
        self.assertEqual(get_data(test_sock_err), self.test_dict_recv_err)
